...
<Meta
    ...
    argTypes={{
        ...
        scrollByTrackSpeed: {
            description: 'pixels per millisecond',
        },
    }}
/>
...
<Template let:args>
    <div class="wrapper">
        <Scrollbar {...args} {wrapper} {container} />
        <div bind:this={wrapper} class="container-wrapper">
            <div bind:this={container} class="container color_line7">
